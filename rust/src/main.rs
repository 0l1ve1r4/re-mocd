...
impl DemoApp {
    fn new(_: &CreationContext<'_>) -> Self {
        ...
        let mut g = graphHandler::generate_graph(FIRST_GRAPH);
    ...
    fn draw_section_simulation(&mut self, ui: &mut Ui) {
        ...
        drawers::draw_start_reset_buttons(
            ...
            |simulation_stopped: bool, reset_pressed: bool, next_graph: bool| {
    ...
    fn reset(&mut self) {
        ...
        self.graph_index += 1;
        let mut g = graphHandler::generate_graph(self.graph_index);
